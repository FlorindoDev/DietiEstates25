...
class CreateAgentWindow extends StatefulWidget {
  const CreateAgentWindow({super.key, required this.appbar});

  final AppBar appbar;

  @override
  State<CreateAgentWindow> createState() => _CreateAgentWindowState();
}

class _CreateAgentWindowState extends State<CreateAgentWindow>{
  bool _obscureText = true;
  bool isCampiCompilati = false;


  AgenteImmobiliare utente = AgenteImmobiliare.builder
      .setId("")
      .setNotify("")
            ...
            TextField(
              ...
              ElevatedButton(
                  onPressed: isCampiCompilati
                      ? () {
                          AgentHomeController.createAgent(context, utente, "");
