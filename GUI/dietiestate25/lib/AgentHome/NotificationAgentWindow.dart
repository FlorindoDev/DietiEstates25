...
class NotificationAgentWindow extends StatefulWidget {
  @override
  State<NotificationAgentWindow> createState() =>
      _NotificationAgentWindowState();
}

class _NotificationAgentWindowState extends State<NotificationAgentWindow> {
  late Future<List<Notify>> notifications;

  void initState() {
    super.initState();
    notifications = AgentHomeController.getNotify(context);
  }
